...
import Backend.BacklogProcessing as final
import time
...
def progress3():
    ...
    # GUI setup
    root = tk.Tk()
    root.title("BillForge-Backlog Version")
...
def gui2():
    ...
    window = tk.Tk()
    window.title("BillForge-Backlog Version")
    window.geometry("770x550")
    window.configure(bg="#F0FBEB")
    window.iconbitmap(relative_to_assets(resource_path('data\\images\\bl_logo_red.ico')))
    ...
    # image_image_1 = PhotoImage(file=relative_to_assets(resource_path("data\\images\\image_15.gif")))
    ...
    gif_frames = load_gif(relative_to_assets(resource_path("data\\images\\image_15.gif")))
    ...
    canvas.create_text(
        ...
        312.0,
        anchor="nw",
        text="Bill Generator Backlog Version",
        fill="#0F32E9",
