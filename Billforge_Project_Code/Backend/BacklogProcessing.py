...
import datasave as DataStore
import showdata as DataExtract
import pandas as pd
...
def excel_add(Teachers_instance):
    ...
    cell.value = Teachers_instance.Script_Examiner
    ...
    cell.value = Teachers_instance.examiners_class_tests
    ...
    if(Teachers_instance.theory_course!="Null"):
    ...
    if Teachers_instance.name in Script_Examiner_course_collection_str:
            ...
            sub_arr1=Script_Examiner_course_collection_str[Teachers_instance.name]
    ...
    #if(Teachers_instance.theory_course!="Null"):
    st1="Null"
    #st1 = teacher_classtest_course_collection_str.get(Teachers_instance.name, "Null")
...
#################################################################
    ...
    #DataStore.savedata(Teachers_instance.name,formatted_value)
    DataStore.savedata2(Teachers_instance.name,formatted_value,"summarydb")
...
def summarygenerator():
     ...
     for teacher in teachers_array:
        ...
        ss=DataExtract.showdata2(teacher.name,"summarydb") # Fetching  Data From Database Showing the teacher's total amount
        print("value: "+ss)
