...
import GUI_Login_ForGeneralDataProceaaingDashboard as GUI_Login_ForGeneralData
import GUI_Login_For_BacklogDataProcessing as GUI_Login_For_BacklogData
import os
import sys
...
def fun1():
    ...
    window.destroy()
    GUI_Login_ForGeneralData.LOGIN_GENERAL()
...
def fun2():
    #print("button_1 clicked")
    window.destroy()
    GUI_Login_For_BacklogData.LOGIN_BACKLOG()
